...
στην πραγματική αξία του αγαθού. Αυτή η διαρρύθμιση λειτουργεί σε περιβάλλοντα όπου ο αριθμός
...
μεταξύ τους χωρίς γνώση της υποκειμενικής αξία του αγαθού. Αυτό δυσκολεύει τον προσδιορισμό ιδανικού
πονταρίσματος και δημιουργίας βέλτιστης στρατηγικής που μεγιστοποιεί το κέρδος. Παραδείγματα τέτοιων
...
που ο πλειοδότης κερδίσει μία δημοπρασία. Η απόκτηση αυτής της γνώσης (της αξίας) συνεπάγεται σε υψηλότερο κόστος
προσφοράς από τον πλειοδότη. Έτσι δημιουργείται μια εγγενή αντιστάθμιση μεταξύ της μάθησης της αξίας και του
κόστους συμμετοχής.

Στόχος κάθε πλειοδότη είναι η ελαχιστοποίησης της μεταμέλειας (regret) σε σχέση με την καλύτερη προσφορά που θα
μπορούσε να είχε γίνεται γνωρίζοντας την αντικειμενική αξία του αντικειμένου.

\subsection{Συναφή έρευνα}

Η παραπάνω προκληση μπορεί να προσεγγιστεί με το μοντέλο των Multi-Armed Bandit (MAB) στο οποίο η κάθε πιθανή
προσφορά αντιμετωπίζεται ώς ένα ανεξάρτητος "βραχίονας" μηχανής κουλοχέρη. Σε αυτή τη περίπτωση ο βαθμός μεταμέλειας
κλιμακώνεται γραμμικά με τον αριθμό προσφορών: $O(\sqrt{T|B|})$. Αυτή η τεχνική θεωρείτε αργή και δεν εκμεταλλεύεται
τη δομή των δημοπρασιών και της μερική ανατροφοδότησης.

Έρευνες που προσπαθούν να εκμεταλλευτούν την παραπάνω πληροφορία αποτελούν οι αλγόριθμοι που βασίζονται σε δημοπρασίες
δεύτερης-τιμής (second-price auctions). Το μειονέκτημα αυτών των αλγορίθμων είναι πως αδυνατούν της προσαρμογής σε
γενικευμένες περιπτώσεις.

Τέλος, επισημαίνεται ότι στην περίπτωση που ο πλειοδότης γνωρίζει πλήρως την αξία του αγαθού, οι ρυθμοί σύγκλισης είναι
πολύ ταχύτεροι. Ωστόσο, αυτή η γνώση είναι σπάνια να υπάρξει στην πράξει σε περιβάλλοντα ψηφιακής οικονομίας.
