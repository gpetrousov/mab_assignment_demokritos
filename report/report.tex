...
\begin{enumerate}[itemsep=0pt, parsep=0pt]
    ...
    \item Ενημερώνει την κατανομή πιθανότητας των προσφορών: 
...
Η κρίσιμη διαφορά του WIN-EXP από τον EXP3 είναι ο ορισμός της εκτίμησης χρησιμότητας $\bar{u}_t(b)$. Στο πλαίσιο της πληροφόρησης μόνο σε περίπτωση νίκης (\textit{win-only feedback}), η εκτίμηση ορίζεται ως:
