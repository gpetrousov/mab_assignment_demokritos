...
μεταξύ τους χωρίς γνώση της υποκειμενικής αξία ($v_t$) του αγαθού. Αυτό δυσκολεύει τον προσδιορισμό της
...
που ο πλειοδότης κερδίσει μία δημοπρασία (win-only feedback). Η απόκτηση αυτής της γνώσης (της αξίας) συνεπάγεται σε
